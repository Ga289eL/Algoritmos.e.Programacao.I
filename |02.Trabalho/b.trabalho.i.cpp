                ...
                for(tentativas=10;tentativas>0&&correto<4;tentativas--){                            //Laço para calcular se o numero sorteado foi decifrado ou não
                    do {                                                                            //Laço para verificar o palpite
                        ...
                        if(p1>0 && p1<7 && p2>0 && p2<7 && p3>0 && p3<7 && p4>0 && p4<7){           //Desvio para verificar se o palpite é valido
                            ...
                            else if(d2==0 && p1==n2 && p2!=n2)                                      //Desvio caso o segundo digito do palpite nao tenha valor (in)correto mas o primeiro numero do palpite for igual ao segundo numero da senha
                            ...
                            if(p2==n2)                                                              //Desvio para verificar se o palpite do segundo numero esta correto
                                correto++;                                                          //Caso esteja a variavel correto recebe mais 1
                            else if(d1==0 && p2==n1 && p1!=n1)                                      //Desvio caso o primeiro digito do palpite nao tenha valor (in)correto mas o segundo numero do palpite for igual ao primeiro numero da senha
                            ...
                            if(p3==n3)                                                              //Desvio para verificar se o palpite do terceiro numero esta correto
                                correto++;                                                          //Caso esteja a variavel correto recebe mais 1
                            else if(d1==0 && p3==n1 && p1!=n1)                                      //Desvio caso o primeiro digito do palpite nao tenha valor (in)correto mas o terceiro numero do palpite for igual ao primeiro numero da senha
                                d1=1;                                                               //Caso seja a variavel d1 (digito) recebe mais 1
                            ...
                            if(p4==n4)                                                              //Desvio para verificar se o palpite do quarto numero esta correto
                                correto++;                                                          //Caso esteja a variavel correto recebe mais 1
                            else if(d1==0 && p4==n1 && p1!=n1)                                      //Desvio caso o primeiro digito do palpite nao tenha valor (in)correto mas o quarto numero do palpite for igual ao primeiro numero da senha
                                d1=1;                                                               //Caso seja a variavel d1 (digito) recebe mais 1
